...
\indent\indent\betastep{کنترل‌گر پیغام \say{رزومه ارسال شد.} را به یک آبجکت \json به صفحه‌ی بارگذاری رزومه می‌فرسند.}
\indent\patchstep{\lr{PDF} نبود، کنترل‌گر، پیغام \say{فرمت فایل رزومه‌ی ارسالی باید \lr{PDF} باشد؛ جهت بازگشت به صفحه‌ی بارگزاری روی پیوند \say{بارگزاری روزمه} کلیک کنید} را با یک آبجکت \json به صفحه‌ی  بارگذاری رزومه می‌فرستد.}

\majorstep{صفحه‌ی بارگذاری رزومه پیغام را به کاربر نشان می‌دهد.}
\subsection{جدول سناریو}
\begin{table}[H]
	\caption{جدول سناریو \arabic{table}}
	\begin{adjustbox}{width=\textwidth}
...
\beginmainstep{لایه‌ی \frontend اطلاعات را به کنترل‌گر کارفرما با یک آبجکت \json می‌فرستد.}
